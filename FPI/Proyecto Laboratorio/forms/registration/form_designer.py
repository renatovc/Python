...
class FormRegisterDesigner():
    ...
    def __init__(self):
        ...
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=200, relief=tk.SOLID, padx=10, pady=10, bg='#FDC42C')
        ...
        title = tk.Label(frame_form_top, text="Registro de usuario", font=(
            'Times', 30), fg="#E6E6E6", bg='#704000', pady=30)
        title.pack(expand=tk.YES, fill=tk.BOTH)
        # end frame_form_top

        # frame_form_fill
        frame_form_fill = tk.Frame(
            frame_form, height=50,  bd=0, relief=tk.SOLID, bg='#704000')
        ...
        inicio = tk.Button(frame_form_fill, text="Registrar", font=(
            'Times', 15), bg='#E6E6E6', bd=0, fg="#3D2300", command=self.register)
